;(function (define, undefined) {
    ...
    ], function (gettext, $, _, Backbone, UserAccountModel, AccountSettingsFieldViews, AccountSettingsView) {

        var setupAccountSettingsSection = function (fieldsData, userAccountsApiUrl) {

            var accountSettingsElement = $('.wrapper-account-settings');
            var accountSettingsModel = new UserAccountModel();
            accountSettingsModel.url = userAccountsApiUrl;
            ...
            accountSettingsModel.fetch({
                ...
                error: function (model, response, options) {
                    accountSettingsView.showErrorMessage();
                }
            });
        }
